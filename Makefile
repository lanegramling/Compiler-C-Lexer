...
test:
	make
	./$(EXE) allTokens.in allTokens.out
	./$(EXE) errorTesting.in errorTesting.out 2> errorTesting.err
	diff allTokens.out expectedNormalOutput.expected
	diff errorTesting.err expectedErrorOutput.expected
